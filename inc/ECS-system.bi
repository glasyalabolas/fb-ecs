...
type ECSSystem extends Object
  ...
  private:
    declare static sub event_entityDestroyed(as any ptr, as ECSEntityChangedEventArgs, as ECSSystem ptr)
    declare static sub event_componentAdded(as any ptr, as ECSComponentChangedEventArgs, as ECSSystem ptr)
    declare static sub event_componentRemoved(as any ptr, as ECSComponentChangedEventArgs, as ECSSystem ptr)
...
sub ECSSystem.event_entityDestroyed(sender as any ptr, e as ECSEntityChangedEventArgs, receiver as ECSSystem ptr)  
...
sub ECSSystem.event_componentAdded(sender as any ptr, e as ECSComponentChangedEventArgs, receiver as ECSSystem ptr)
...
sub ECSSystem.event_componentRemoved(sender as any ptr, e as ECSComponentChangedEventArgs, receiver as ECSSystem ptr)  
  if sender = receiver->_components then
...
sub ECSSystem.process(dt as double = 0.0)
