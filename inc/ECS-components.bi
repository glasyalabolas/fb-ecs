...
type ECSComponents extends Object
  ...
  private:
    declare static sub event_entityDestroyed(as any ptr, as ECSEntityChangedEventArgs, as ECSComponents ptr)
...
operator ECSComponents.[](id as ECSComponent) as any ptr
  return cptr(ubyte ptr, strptr(_components(id).value))
end operator

operator ECSComponents.[](n as string) as any ptr
  return cptr(ubyte ptr, strptr(_components(getID(n)).value))
end operator
...
function ECSComponents.getComponent(e as ECSEntity, c as ECSComponent) as any ptr
  return cptr(ubyte ptr, strptr(_components(c).value)) + e * _components(c).size
end function
...
function ECSComponents.removeComponent(e as ECSEntity, c as string) as boolean
  return removeComponent(e, cptr(ECSComponentTableEntry ptr, _hashTable->find(lcase(c)))->id)
end function
...
sub ECSComponents.event_entityDestroyed(sender as any ptr, e as ECSEntityChangedEventArgs, receiver as ECSComponents ptr)
